...
WP6Header::WP6Header(RVNGInputStream *input, WPXEncryption *encryption, uint32_t documentOffset, uint8_t productType,
...
void WP6Header::_readIndexInformation(RVNGInputStream *input, WPXEncryption *encryption)
{

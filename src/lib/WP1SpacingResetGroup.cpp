...
WP1SpacingResetGroup::WP1SpacingResetGroup(RVNGInputStream *input, WPXEncryption *encryption, uint8_t group) :
...
void WP1SpacingResetGroup::_readContents(RVNGInputStream *input, WPXEncryption *encryption)
{

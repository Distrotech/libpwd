...
WP5FootnoteEndnoteGroup::WP5FootnoteEndnoteGroup(RVNGInputStream *input, WPXEncryption *encryption) :
...
void WP5FootnoteEndnoteGroup::_readContents(RVNGInputStream *input, WPXEncryption *encryption)
{

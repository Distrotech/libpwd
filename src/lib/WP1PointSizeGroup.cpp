...
WP1PointSizeGroup::WP1PointSizeGroup(RVNGInputStream *input, WPXEncryption *encryption, uint8_t group) :
...
void WP1PointSizeGroup::_readContents(RVNGInputStream *input, WPXEncryption *encryption)
{

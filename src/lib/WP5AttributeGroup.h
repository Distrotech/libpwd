...
{
public:
	WP5AttributeGroup(RVNGInputStream *input, WPXEncryption *encryption, uint8_t groupID);
...
{
public:
	WP5AttributeOnGroup(RVNGInputStream *input, WPXEncryption *encryption, uint8_t groupID);
...
{
public:
	WP5AttributeOffGroup(RVNGInputStream *input, WPXEncryption *encryption, uint8_t groupID);
	void parse(WP5Listener *listener);
};

...
{
public:
	WP6Header(RVNGInputStream *input, WPXEncryption *encryption, uint32_t documentOffset, uint8_t productType,
...
protected:
	void _readIndexInformation(RVNGInputStream *input, WPXEncryption *encryption);

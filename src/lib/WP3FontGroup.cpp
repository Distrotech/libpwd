...
WP3FontGroup::WP3FontGroup(RVNGInputStream *input, WPXEncryption *encryption) :
...
void WP3FontGroup::_readContents(RVNGInputStream *input, WPXEncryption *encryption)
{

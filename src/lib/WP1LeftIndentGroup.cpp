...
WP1LeftIndentGroup::WP1LeftIndentGroup(RVNGInputStream *input, WPXEncryption *encryption, uint8_t group) :
...
void WP1LeftIndentGroup::_readContents(RVNGInputStream *input, WPXEncryption *encryption)
{

...
WP5TableEOPGroup::WP5TableEOPGroup(RVNGInputStream *input, WPXEncryption *encryption) :
...
void WP5TableEOPGroup::_readContents(RVNGInputStream * /* input */, WPXEncryption * /* encryption */)
{
	switch (getSubGroup())
	{
